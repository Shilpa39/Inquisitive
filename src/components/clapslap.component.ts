    ...
    template: `
        <ion-row>
            <ion-col center text-center>
                <button ion-button icon-left clear small (click)="upvote()" style="color:white;">
            ...
            <ion-col center text-center>
                <button ion-button icon-left clear small style="color:white;">{{initVotes}}</button>
            </ion-col>

            <ion-col center text-center>
                <button ion-button icon-left clear small (click)="downvote()" style="color:white;">
